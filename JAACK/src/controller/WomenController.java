...
public class WomenController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        Image beigeCap = new Image(Bcap.getProductImage());
        ...
        mcoq.setProductImage("images/beige dress.jpg");
        Image MiniCoquette = new Image(mcoq.getProductImage());
        ...
        Shoes.setProductImage("images/beige shoes.jpg");
        Image BeigeShoes = new Image(Shoes.getProductImage());
        ...
        cap.setProductImage("images/Bucket.jpg");
        Image Bucket = new Image(cap.getProductImage());
